				...
				<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
					<div class="sidebar">
						<div class="portfolio-desc">
							...
							<p>Oat cake oat cake dessert brownie. Gummies tiramisu tart jujubes jelly beans macaroon danish pie muffin. Soufflé pudding brownie pudding fruitcake marshmallow I love. Dragée jujubes chocolate cake jelly beans.
							</p>
							<br>
						...
						<p><a href="#" class="btn btn-primary">Project Link</a></p>
					</div>
				</div>
			</div>
			<!-- sidebar end -->
		  ...
		  <div class="row wow bounceIn">
		  		<div class="col-md-12">
		  			<div class='text-center'>
			    		<h2 class="title"><span>Related Project</span></h2>
			    	</div>
		  		</div>
		  </div><!--/ Title row end -->
