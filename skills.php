...
<head>
	...
	================================================== -->
	<meta charset="utf-8">
    <title>Anjay Ajodha-Skills</title>
	...
	<section id="about-page">
		<div class="container">
			<div class="row">
				<div class="col-md-12 wow bounceIn">
		  			<div class='text-center'>
			    		<h2 class="title"><span>Programming Languages</span></h2>
			    	</div>
	  			</div>

		        <div class="skills wow fadeInUp">
		          <div class="col-md-3">
		            <div class="percentage easyPieChart" data-percent="85" data-delay="100"><span>Intermediate</span>%<canvas width="165" height="165"></canvas></div>
		            <small>C#</small> </div>
		          <div class="col-md-3">
			...
			<div class="row">
				<div class="col-md-12 wow bounceIn">
					<div class='text-center'>
						<h2 class="title"><span>Microsoft Technologies</span></h2>
					</div>
				</div>
			...
			<div class="row">
				<div class="col-md-12 wow bounceIn">
					<div class='text-center'>
						<h2 class="title"><span>System Administration</span></h2>
					</div>
				</div>
				...
				<div class="skills wow fadeInUp">
					...
					<div class="col-md-3">
						...
						<small>Systems Monitoring</small> </div>
				</div>
			...
			<div class="row">
				<div class="col-md-12 wow bounceIn">
					<div class='text-center'>
						<h2 class="title"><span>Interpersonal Skills</span></h2>
					</div>
				</div>
